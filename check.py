...
# STEP 9 — Save Model
# ================================
model.save("pneumonia_detector_v3.keras")
print("\nModel saved as pneumonia_detector_v3.keras! ✅")
...
fig.suptitle('Pneumonia Detector V3 — Final Results',
             fontsize=14)
plt.tight_layout()
plt.savefig('v3_results.png')
plt.show()

print("\nGraph saved as v3_results.png! ✅")
print("\n🏥 Medical AI Model V3 Ready!")